...
const PartnerStats = ({ totalUnverDoctor, totalVerDoctor, totalClinics }) => {
  return (
    <div className="col-span-2 p-2 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl border border-gray-200 shadow-sm content-center">
      <div className='p-3 bg-gradient-to-r from-blue-600 to-blue-700 text-gray-100 rounded-xl content-center justify-center my-auto'>
