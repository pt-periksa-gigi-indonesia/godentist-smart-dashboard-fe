...
const Navbar = ({ toggleSidebar, isCollapsed }) => {
    ...
    return (
        <nav className={`bg-white shadow-md fixed top-0 ${isCollapsed ? 'left-0' : 'left-64'} right-0 z-50 flex items-center justify-between p-4 h-16 transition-all duration-300`}>
            ...
            <div className="relative flex items-center space-x-4">
                ...
                <div
                    ref={dropdownRef}
                    className={`absolute right-0 mt-24 w-48 bg-white rounded-md shadow-lg py-1 z-50 transition-all duration-300 ${
