...
export const config = {
    matcher: [ '/dashboard/:path*','/dashboard/admin', '/login', '/register', '/dashboard/settings', '/waiting', "/dashboard/doctors", "/dashboard/clinics", "/dashboard/feedbacks", "/reset-password/[token]", "/forgot-password"] 
};
